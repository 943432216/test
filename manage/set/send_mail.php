...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table">
	<!--<tr> 
		<td nowrap><?=get_lang('set.send_mail.module');?>:</td>
		<td width="95%">
	...
	<tr> 
		<td nowrap  width="5%"><?=get_lang('set.send_mail.from_email');?>:</td>
		<td width="95%"><input name="FromEmail" type="text" value="<?=htmlspecialchars($mCfg['SendMail']['FromEmail']);?>" class="form_input" size="30" maxlength="100" check="<?=get_lang('ly200.filled_out').get_lang('set.send_mail.from_email');?>!~*"></td>
	</tr>
	<tr> 
